    ...
    <>
      ...
      <div className="flex flex-col flex-wrap md:flex-row">
        <div className="h-[54vh] min-w-[300px] md:order-2">
          <Image src={tesseract} alt="Picture of tesseract" className="m-auto mt-[8vh] invert drop-shadow-glow"/>
            </div>
        <div className="flex flex-col md:order-1 md:ml-[8rem] md:mt-[14rem] mx-12">
          <h1 className="text-5xl md:text-8xl font-semibold max-w-[250px] my-1 bg-gradient-to-r from-[#91ffff] to-[#e9ffff] text-transparent bg-clip-text">
            Alfons Stoltz
          </h1>
      ...
      <hr className="mt-[18vh] h-[2px]" />
      <div className="mt-[10vh]">
        <div className="flex flex-col">
          <div className="h-[64vh] w-screen overflow-hidden relative">
      ...
      <div className="h-20 w-screen flex justify-center items-center gap-5 sticky">
